    ...
    <form id="form1" runat="server">
        ...
        <div class="central">
            <div style="height: 55px; width: 392px; text-align: right;" class="auto-style2">
                ...
                <asp:TextBox ID="Username" runat="server" CssClass="input input2" ToolTip="For example: Jan Kowalski" OnTextChanged="Username_TextChange" AutoPostBack="true" CausesValidation="true"></asp:TextBox>
                ...
                <asp:CustomValidator ID="Error_login" runat="server" ControlToValidate="Username" OnServerValidate="Check_if_logged" ValidationGroup="grupa"></asp:CustomValidator>
                <br />
                <br />
                <div style="height: 81px; text-align: center" class="auto-style2">
                    ...
                    <div class="auto-style1">
                        ...
                        <asp:TextBox ID="Birthday" runat="server" CssClass="input" ToolTip="For example: 25-11-1995" Enabled="False" Format="dd-MM-yyyy" AutoPostBack="true"></asp:TextBox>
                    ...
                    <div style="width: 394px; height: 175px" class="auto-style2">
                        ...
                        <div class="auto-style1" style="height: 136px; margin-top: 0px">
                            ...
                            <asp:TextBox ID="Street" runat="server" CssClass="input" ToolTip="For example: Krakowska" Enabled="False" OnTextChanged="Street_TextChange" AutoPostBack="true"></asp:TextBox>
                            ...
                            <asp:TextBox ID="House" runat="server" CssClass="input" ToolTip="For example: 12A/45" Enabled="False" OnTextChanged="House_TextChange" AutoPostBack="true"></asp:TextBox>
                            ...
                            <asp:TextBox ID="City" runat="server" CssClass="input" ToolTip="For example: Warszawa" Enabled="False" OnTextChanged="City_TextChange" AutoPostBack="true"></asp:TextBox>
                            ...
                            <asp:TextBox ID="Postal" runat="server" CssClass="input" ToolTip="For example: 02-535" Enabled="False" OnTextChanged="Postal_TextChange" AutoPostBack="true"></asp:TextBox>
        ...
        <asp:UpdatePanel ID="Online_users" runat="server">
            <ContentTemplate>
                <div class="auto-style3">
                    <div style="width: 82px; height: 120px;" class="buttons">
                      <asp:Button ID="Button_next" runat="server" Text="Next" Height="28px" Width="82px" Enabled="False" AutoPostBack="True" OnClick="Next" />
                      <asp:Button ID="Button_prev" runat="server" Text="Previous" Height="28px" Width="82px" Enabled="False" AutoPostBack="True" OnClick="Prev" />
                    </div>
                    <div id="lista">
                        <asp:DropDownList ID="list" runat="server" AutoPostBack="True" Enabled="False" OnSelectedIndexChanged="user_change" size="5" Height="400px" Width="300px"></asp:DropDownList>
                        <asp:Timer ID="refresh" runat="server" Interval="8000" OnTick="list_update" Enabled="False" />
                    </div>
                </div>
            </ContentTemplate>
            <triggers>
                <asp:postbacktrigger controlid="list"/>
                <asp:postbacktrigger controlid="button_next"/>
                <asp:postbacktrigger controlid="button_prev"/>
            </triggers>
        </asp:UpdatePanel>
    </form>
</body>
